...
def track_scatterplot_matrix():
    ...
    matrix = pd.plotting.scatter_matrix(all_df[['valence', 'acousticness',
                                       'instrumentalness', 'speechiness']], 
                                       figsize=(10, 10), marker='o', alpha=0.7)
...
def single_artist_box():
    ...
    min_value = df[['valence', 'acousticness', 'instrumentalness', 'speechiness']].min().min()
    max_value = df[['valence', 'acousticness', 'instrumentalness', 'speechiness']].max().max()
    ...
    for i, artist in enumerate(unique_artists):
        ...
        for j, feature in enumerate(['valence',
                                     'acousticness', 
                                     'instrumentalness', 
                                     'speechiness']):
