...
def test_multiple_features():
    write_data_to_csv(
        {"a": {"loudness": 1, "tempo": 120, "energy": 0.8}},
        "test_multiple_features.csv",
...
def test_multiple_artists_and_features():
    write_data_to_csv(
        {
            "a": {"loudness": 1, "tempo": 110, "energy": 0.8},
            "b": {"loudness": 1, "tempo": 120, "energy": 0.8},
            "c": {"loudness": 2, "tempo": 130, "energy": 0.8},
        },
        "test_multiple_artists_features.csv",
        ["loudness", "tempo", "energy"],
    )
...
def test_csv_content():
    test_data = {
        "Rin": {"loudness": 0.5, "tempo": 120, "energy": 0.8},
        "Len": {"loudness": 0.5, "tempo": 120, "energy": 0.6},
    }
    write_data_to_csv(
        test_data, "test_content.csv", ["loudness", "tempo", "energy"]
    )
